            ...
            <div class="main-content-2">
                <div class="heading-container"><div class="text-wrapper-8">Announcements, Department Chair</div></div>
                    <div class="container-management">
								<div class="postAnnouncement-container-edit">
									<form id="editAnnouncement" method="post" action="http://localhost/GitHub/facultyportal/index.php/common_controllers/Announcements/update/<?php echo $announcement->id; ?>" enctype="multipart/form-data">
										<div class="postAnnouncement-container">
											<div class="postmodal-heading">
												<div class="div">Edit Announcements</div>
											</div>
											<div class="postmodal-form-container">
												<!-- Title Input -->
												<div class="postmodal-form-input">
													<input type="text" id="title" name="title" placeholder="Title" value="<?php echo htmlspecialchars($announcement->title); ?>">
												</div>
												<!-- Custom Textarea for Announcement Body -->
												<div class="postmodal-form-input">
													<textarea type="textarea" id="announcement_body" class="custom-textarea1" contenteditable="true" name="content" 
														placeholder="Write your announcement here..."><?php echo htmlspecialchars($announcement->content); ?></textarea>
												...
												<div class="existing-attachments">
													...
													<?php if (!empty($attachments)): ?>
														<div class="edit-attachment-container">
															<?php foreach ($attachments as $attachment): ?>
																<div class="edit-attachment-item">
																	...
																	<?php endif; ?>
																	<a href="<?php echo base_url($attachment->announcement_file_path); ?>" class="file-name" target="_blank">
																		<?php echo basename($attachment->announcement_file_path); ?>
																	</a>
																	<a href="http://localhost/GitHub/facultyportal/index.php/common_controllers/Announcements/delete_attachment/<?php echo $attachment->id; ?>" class="remove-file-btn" onclick="return confirm('Are you sure you want to delete this attachment?');">Delete</a>
																</div>
															<?php endforeach; ?>
														</div>				
													<?php else: ?>
											...
											<div class="button-container">
												...
												<a href="http://localhost/GitHub/facultyportal/index.php/common_controllers/Announcements/index" id="closeModalBtn">

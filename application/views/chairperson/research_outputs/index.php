...
<html>
  ...
  <div class="dashboard-faculty">
			...
			<a href="http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/FacultyManagement/index">
		  	...
		  	<a href="http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/index">
				<div class="nav-link active">
					...
					<div class="frame-2"><div class="text-wrapper-4 highlight">Research Outputs</div></div>
				</div>
			</a>
							...
							<button id="addResearchBtn" type="button" class="btn">+ &nbsp&nbsp Add Research</button>
								...
								<div id="addResearchModal" class="modal">
									<div class="modal-content">
										...
										<form id="addResearchForm" method="post" action="http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/createResearch" enctype="multipart/form-data">
	...
	function fetchResearch(query = '') {
		$.ajax({
			url: 'http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/getResearch',  // Update the URL as necessary
			type: 'GET',
			data: { search: query },
			dataType: 'json',
			success: function(result) {
		...
		result.forEach(function(item) {
			...
			tr += "<td><a href='#' onclick='fetchResearchById(" + item.id + ")'>" +
					"<div class='table-icon-container'>" +
						...
						"<div><a href='http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/deleteResearch/" + item.id + "'>" +
	...
	function fetchResearchById(researchId) {
		$.ajax({
			url: 'http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/getResearchByID/' + researchId,
			type: 'GET',
			dataType: 'json',
			success: function(result) {
	...
	function populateEditResearchModal(research) {
		...
		if (research.research_attachment) {
			attachmentPreview.html(
				`<a href="http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/viewResearchPDF/${research.id}" target="_blank">View Existing PDF</a>`
			);
		} else {
			attachmentPreview.html('');
		}
		...
		$('#editResearchForm').attr(
			'action',
			'http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/ResearchOutputs/updateResearch/' + research.id
		);

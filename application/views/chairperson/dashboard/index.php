  ...
  <div class="dashboard-faculty">
        ...
        <div class="nav-links-container">
			<a href="http://localhost/GitHub/facultyportal/index.php/chairperson_controllers/Dashboard/index">
				<div class="nav-link active">
					...
					<div class="frame-2"><div class="text-wrapper-4 highlight">Dashboard</div></div>
				</div>
			</a>
      ...
      <div class="main-content">
        <div class="main-content-2">
          <div class="heading-container"><div class="text-wrapper-8">Welcome, <?php echo $this->session->userdata('logged_id'); ?> Department Chair</div></div>
